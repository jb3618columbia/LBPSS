...
if act ==1
    name = strcat('Act_mag','','Temp', num2str(round(temp)), 'Bias', num2str(scale_bias*100), 'Corr', num2str(scale_corr*100));
    path = '/Users/Jalaj/Documents/Github - LBPSS/Outputs_after_NIPS/Actmag/';
else
    name = strcat('Pair_marg','','Temp', num2str(round(temp)), 'Bias', num2str(scale_bias*100), 'Corr', num2str(scale_corr*100));
    path = '/Users/Jalaj/Documents/Github - LBPSS/Outputs_after_NIPS/Pairmarginal/';
end
