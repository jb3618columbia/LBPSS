function [legend_h,object_h,plot_h,text_strings] = columnlegend(numcolumns, e0, str, height, varargin)
%
...
if legend_h == false,
    %create the legend
    [legend_h,object_h,plot_h,text_strings] = legend(e0, str);
end
...
switch lower(location),
    ...
    case {'southoutside'}
        ...
        set(legend_h, 'position', [fig_pos(1)+fig_pos(3)/2-pos(3)/2 -fig_pos(2)-pos(4)/2 pos(3)+1 pos(4)]+1);
    case {'eastoutside'}
        % need to resize axes to allow legend to fit in figure window
        set(gca, 'position', [fig_pos]-[0 0 pos(3) 0]);
