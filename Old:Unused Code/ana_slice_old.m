function [ xx, dist_est, cur_log_like, curr_fn_evals ] = ana_slice_old( xx, prior, f, cur_log_like, clique_size)
...
theta_accept = zeros(2*d+1,1); % On a circle there are 2d points 
