function [xx, cur_log_like, curr_fn_evals] = discrete_ess( xx, prior, f, cur_log_like, angle_range )
%  Does slice sampling on a circle than a line
...
% GEtting the thresholds in [-pi/2, pi/2]
t = (-pi/2) + rand(dim,1)*pi;
